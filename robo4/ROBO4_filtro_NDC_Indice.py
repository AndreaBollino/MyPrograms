...
def countNDCad1(jwt):
    url = 'https://digitaladvisory-elk-wvk8snpwaelasticsearch-sysprod.apps.fi1.paas.gmps.global:443/bsrobo4-risp-picking-'+indice+'/_count'
...
def updateNDCstrategiaNULL(listaxls):
    url = 'https://digitaladvisory-elk-wvk8snpwaelasticsearch-sysprod.apps.fi1.paas.gmps.global:443/bsrobo4-risp-picking-'+indice+'/_update_by_query'
    autorization = 'Bearer'+ jwt
    autorization = autorization.replace('"', '')
    autorization = autorization.replace('}', '')
    #print(autorization)
